            ...
            if data:
                ...
                for itP in range(0, y_classes.shape[0]):
                    try:
                        ...
                        # send in output face centroid, true/false, confidence level
                        centroid_bottle = yarp.Bottle()
                        centroid_bottle.addDouble(ld[0])
                        centroid_bottle.addDouble(ld[1])
